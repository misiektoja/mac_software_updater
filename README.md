...
[![Version](https://img.shields.io/badge/version-1.3.6-blue)](https://codeberg.org/pr-fuzzylogic/mac_software_updater/releases)
...
```bash
curl -L https://github.com/pr-fuzzylogic/mac_software_updater/releases/download/v1.3.6/Installer.zip -o Installer.zip && unzip -q Installer.zip && cd mac_software_updater && chmod +x setup_mac.sh && ./setup_mac.sh
```
